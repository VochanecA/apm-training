// components/ui/hero-carousel.tsx - dodatak van carousel-a
"use client"
...
import QRScannerCard from "./qr-scanner-card" // Nova komponenta
...
export function HeroCarousel({ 
  ...
  return (
    <>
        ...
        <div className="relative aspect-[4/3] w-full">
          {images.map((image, index) => (
            ...
            >
              <Image
                src={image}
                alt={`Training management ${index + 1}`}
                fill
      ...
      {/* QR Scanner Card - ispod carousel-a */}
      {showQRScanner && (
        <div className="mt-8">
          <QRScannerCard />
        </div>
